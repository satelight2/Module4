...
<head>
    ...
    <link rel="stylesheet" href="../../rss/vendor/glightbox/css/glightbox.min.css">
    <!-- Range slider-->
    <link rel="stylesheet" href="/rss/vendor/nouislider/nouislider.min.css">
    <!-- Choices CSS-->
    <link rel="stylesheet" href="../rss/vendor/choices.js/public/assets/styles/choices.min.css">
    <!-- Swiper slider-->
